...
urlpatterns = [
    ...
    path('research/analytics/', views.researcher_analytics_data, name='researcher_analytics_data'),
    path('research/export/filtered/', views.export_filtered_research_csv, name='export_filtered_research_csv'),
    path('research/export/summary-pdf/', views.export_research_pdf_summary, name='export_research_pdf_summary'),
    path('research/export/', views.export_research_excel, name='export_research_excel'),
        path('research/statistical-tests/', views.parametric_tests, name='parametric_tests'),
